...
Для того, чтобы объединить тестовые методы сценария в тестовый набор, необходимо разместить аннотацию [`&ТестовыйНабор`](./docs/api/Аннотации/ТестовыйНабор.md) над конструтором сценария.
