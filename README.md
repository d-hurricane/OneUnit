...
Каждый сценарий с тестами по умолчанию представляет собой тестовый набор. Если по каким-либо причинам потребовалось опеределить конструктор `ПриСозданииОбъекта` сценария,
